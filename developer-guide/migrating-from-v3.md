...
| **Maven artifact** | `4.0.0-SNAPSHOT` builds publish to the [UserDerezzed Reposilite](https://repo.userderezzed.dev) repo; release builds publish to the same host at the release coordinate. The old Sonatype / Maven Central coordinate is discontinued. |
