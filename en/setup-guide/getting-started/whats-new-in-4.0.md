...
<div><figure><img src="../.gitbook/assets/capybara-square.gif" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/chameleon-square.gif" alt=""><figcaption></figcaption></figure></div>
...
**MyPet 4 bundles two custom Pet models - the Capybara and the Chameleon!** These are provided by [HeavenCreations](https://builtbybit.com/creators/heavencreations.326565/), huge thanks to them. (above gifs are not to scale) The **models** ship inside the jar; you turn each one into a Pet type with a short `pet-config.yml` section and MyPet installs the model file for you - see [Bundled Models - Capybara & Chameleon](systems/custom-pet-models/bundled-pet-models.md).
