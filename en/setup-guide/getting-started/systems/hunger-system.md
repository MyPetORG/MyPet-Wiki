...
The Hunger-System is based on saturation. The saturation is a value between **1** and **100**, where **100** is the best and **1** is the worst. After a period of time (can be set with the `MyPet.HungerSystem.Time` setting) the saturation decreases and affects other stats of your pet.
...
Lower saturation results in a lower range of the beacon effect.

#### [Ride](../../skilltree-creation/creating-custom-skilltrees/skills/ride.md)

Lower saturation results in your pet running slower while riding it.
