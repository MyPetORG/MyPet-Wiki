...
{% hint style="info" %}
If you use MythicMobs or ItemsAdder to spawn modeled creatures in the world, players can tame them as custom pets. See [Custom Pet Models](custom-pet-models/) for how to set this up.
{% endhint %}
